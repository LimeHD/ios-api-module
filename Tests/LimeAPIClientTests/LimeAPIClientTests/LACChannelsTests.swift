...
extension LimeAPIClientTests {
    ...
    func test_requestChannels_correctResponseData_callsCompletionWithSuccess() throws {
        var completion: APICompletion<[Channel]>?
        let data = try generateJSONData(JSONAPIObject<[Channel], String>.self, string: ChannelExample.default)
    ...
    func test_requestChannelsByGroupId_correctResponse_contentTypeNull_callsSuccess() throws {
        var completion: APICompletion<[Channel]>?
        let data = try generateJSONData(JSONAPIObject<[Channel], String>.self, string: ChannelExample.contenTypeNull)
